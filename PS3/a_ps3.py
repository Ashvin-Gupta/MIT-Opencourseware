    ...
    while (calculate_handlen(hand) > 0):
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            if is_valid_word(word, hand, word_list):
                ...
                print(f"You scored {points} points for this word.", points)
                score += points
                print("Score: ",score)
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    word_list: list of lowercase strings
    """
    number_games = int(input("How many series of hands do you want to play? "))
    substitute = 1
    replay = 1
    score = 0
    ...
    while number_games > 0:
        ...
        if substitute ==1:
            change  = input("Do you want to substitute a letter in your hand? ")
            if change.lower() == "yes":
                letter_change = input("What letter would you like to change? ")
                substitute_hand(hand, letter_change)
                substitute = 0
        
        s = play_hand(hand, word_list)
        number_games -= 1
        score += s

        if replay == 1:
            again = input("Do you want to replay your hand? ")
            if again.lower() == "yes":
                play_game(hand, word_list)
                number_games -= 1
                replay = 0
